...
module.exports = class LedgerNodeRecords {
  ...
  async get({maxBlockHeight, recordId}) {
    ...
    const latestBlockHeight = latestBlockSummary.eventBlock.block.blockHeight;
    ...
    // clear the summary cache if max block height is greater than the
    // latest block height and fetch maxBlockHeight directly from database
