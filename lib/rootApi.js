...
const {util: {callbackify, hasValue, uuid, BedrockError}} = bedrock;
...
const lruMemoize = new LruMemoize({max: 1000});
...
async function _findLedgerNode({actor, ledgerNodeId}) {
  ...
  // FIXME: is it safe to make this if(actor && record.ledgerNode.owner)
  // what are important distinctions between undefined and null in this case?
